...
/**
 * GET /api/most-commented?limit=12&offset=0
 * Retorna conteúdo mais comentado paginado, enriquecido com cover_url, genre e status +18.
 */
export async function GET(req: NextRequest) {
    ...
    const { data: items, error } = await (supabase.rpc as any)(
        ...
        { p_limit: limit + 5, p_offset: offset }
    );
    ...
    // Filtrar comunicados oficiais antes de contar
    ...
    // Buscar covers e status +18 para as séries retornadas
